...
export default function ChatPage({ mode = "light", toggleMode, ...props }) {
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-0 mb-4 sm:mb-6">
                <div>
                  ...
                  <p className="text-sm sm:text-base text-gray-600">
                    Send and receive messages to staff and customers
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-1 gap-6 mt-6 py-10">
              <div className="flex flex-col items-center justify-center h-full w-full ">
                ...
                <p className="text-lg text-center max-w-xl mb-8 text-gray-500 dark:text-gray-300">
                  We&apos;re finalizing the Chat platform to ensure you get
