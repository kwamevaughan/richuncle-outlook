      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
        <div className="flex items-center gap-6">
          ...
          <div className="relative group">
            <div className="w-24 h-24 bg-gradient-to-br from-blue-500 via-purple-500 to-indigo-600 rounded-2xl flex items-center justify-center overflow-hidden shadow-lg ring-4 ring-white">
              {user.avatar_url ? (
                <img
                  src={user.avatar_url}
                  alt={user.name}
            ...
            {isEditing && (
              <button
                ...
                className="absolute -bottom-2 -right-2 w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-full flex items-center justify-center hover:from-blue-600 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 group-hover:scale-105"
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              >
                <Icon 
                  icon={user.role === "admin" ? "solar:crown-bold" : user.role === "manager" ? "solar:user-id-bold" : "solar:user-bold"} 
              ...
              >
                <Icon 
                  icon={user.is_active ? "solar:check-circle-bold" : "solar:close-circle-bold"} 
                  className="w-4 h-4 mr-1" 
                />
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <Icon icon={isEditing ? "solar:close-circle-bold" : "solar:pen-bold"} className="w-4 h-4 mr-2" />
