    ...
    <div className="space-y-6">
          ...
          <div className="flex items-center justify-between py-3 border-b border-gray-50 last:border-b-0">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center">
                <Icon icon="solar:calendar-plus-bold" className="w-4 h-4 text-blue-600" />
              </div>
              <div>
          ...
          <div className="flex items-center justify-between py-3 border-b border-gray-50 last:border-b-0">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-green-100 rounded-lg flex items-center justify-center">
                <Icon icon="solar:calendar-edit-bold" className="w-4 h-4 text-green-600" />
              </div>
              <div>
          ...
          <div className="flex items-center justify-between py-3 border-b border-gray-50 last:border-b-0">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-purple-100 rounded-lg flex items-center justify-center">
                <Icon icon="solar:login-3-bold" className="w-4 h-4 text-purple-600" />
              </div>
              <div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div className="p-6 space-y-3">
          ...
          >
            <Icon icon="solar:logout-3-bold" className="w-4 h-4 mr-3 text-gray-500 group-hover:text-gray-700" />
            Sign Out
          </button>
          <button
          ...
          >
            <Icon icon="solar:trash-bin-trash-bold" className="w-4 h-4 mr-3 text-red-500 group-hover:text-red-600" />
            Delete Account
          </button>
        </div>
      </div>
